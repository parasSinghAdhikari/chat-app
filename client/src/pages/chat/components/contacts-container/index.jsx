...
import ProfileInfoContainer from "./components/profile-info";
...
const ContactsContainer = () => {
    ...
    const {directMessagesContacts,setDirectMessagesContacts,channels,setChannel} = useAppStore();
...
const Logo = () => {
    return (
      <div className="flex p-5  justify-start items-center gap-2">
        ...
        <span className="text-3xl font-semibold ">Chatting</span>
      </div>
    );
  };
