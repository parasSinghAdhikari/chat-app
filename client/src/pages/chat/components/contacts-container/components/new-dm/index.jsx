...
import { SEARCHED_CONTACTS_ROUTE } from "@/utils/constants";
        ...
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1  md:flex flex-col justify-center items-center mt-5 md:mt-0 duration-1000 transition-all">
              ...
              <div className="text-opacity-80 text-white flex flex-col gap-5 items-center justify-center mt-5 lg:2xl text-xl transition-all duration-300 text-center">
